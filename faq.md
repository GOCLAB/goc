...
* 作为新人，希望走好技术路线，该如何学习，学到什么？
  ...
  * What: 通过工程实践提升自己的专业技能，沟通能力，协作能力和了解计算机工程项目的意义。具体技术来说是，通过GOC项目学会熟练使用项目开发环境和管理软件，夯实C++和Python语言编程能力，提升debug能力，功能设计和实现能力，了解设计模式，熟悉网络编程。
* 密码学知识与背景
  ...
  * 目前区块链（包括比特币、以太坊、EOS）基本上只用到了签名验签，并且不可缺少的依赖签名验签功能。在此给出一张代表性的签名验签的流程图![avatar](./avatar/signature.png)
