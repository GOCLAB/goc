 ...
 */
void apply_gocio_newaccount(apply_context& context) {
...
//   context.require_write_lock( config::eosio_auth_scope );
   ...
   if( !creator.privileged ) {
      EOS_ASSERT( name_str.find( "gocio." ) != 0, action_validate_exception,
                  "only privileged accounts can have names that start with 'gocio.'" );
   }
...
void apply_gocio_setcode(apply_context& context) {
...
void apply_gocio_setabi(apply_context& context) {
   auto& db  = context.db;
...
void apply_gocio_updateauth(apply_context& context) {
   ...
   EOS_ASSERT( update.permission.to_string().find( "gocio." ) != 0, action_validate_exception,
               "Permission names that start with 'gocio.' are reserved" );
...
void apply_gocio_deleteauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_gocio_linkauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_gocio_unlinkauth(apply_context& context) {
//   context.require_write_lock( config::eosio_auth_scope );
...
void apply_gocio_canceldelay(apply_context& context) {
