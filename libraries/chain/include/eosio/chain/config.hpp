...
const static uint64_t system_account_name    = N(gocio);
const static uint64_t null_account_name      = N(gocio.null);
const static uint64_t producers_account_name = N(gocio.prods);
...
const static uint64_t eosio_auth_scope       = N(gocio.auth);
const static uint64_t eosio_all_scope        = N(gocio.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(gocio.any);
const static uint64_t eosio_code_name = N(gocio.code);
