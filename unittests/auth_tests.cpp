...
BOOST_AUTO_TEST_CASE(link_auths) { try {
   ...
   chain.link_authority("alice", "gocio", "spending",  "reqauth");
   ...
   BOOST_CHECK_THROW( chain.link_authority("alice", "gocio", "spending",  "reqauth"), action_validate_exception);

   // Unlink alice with eosio reqauth
   chain.unlink_authority("alice", "gocio", "reqauth");
   ...
   chain.link_authority("alice", "gocio", "scud");
...
BOOST_AUTO_TEST_CASE(link_then_update_auth) { try {
   ...
   chain.link_authority("alice", "gocio", "first",  "reqauth");
...
try {
   ...
   // Creating account with gocio. prefix with privileged account
   chain.create_account("gocio.test1");

   // Creating account with gocio. prefix with non-privileged account, should fail
   BOOST_CHECK_EXCEPTION(chain.create_account("gocio.test2", "joe"), action_validate_exception,
                         fc_exception_message_is("only privileged accounts can have names that start with 'gocio.'"));
...
BOOST_AUTO_TEST_CASE( any_auth ) { try {
   ...
   chain.link_authority( "alice", "gocio", "gocio.any", "reqauth" );
   chain.link_authority( "bob", "gocio", "gocio.any", "reqauth" );
