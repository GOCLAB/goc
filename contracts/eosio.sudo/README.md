...
$ cat newaccount_payload.json
{
   ...
   "owner": {
      ...
      "keys": [],
      "accounts": [{
         "permission": {"actor": "gocio", "permission": "active"},
         "weight": 1
      }],
      "waits": []
   },
...
```
$ cleos set account permission -s -j -d alice owner '{"threshold": 1, "accounts": [{"permission": {"actor": "gocio", "permission": "active"}, "weight": 1}]}' > update_alice_owner_trx.json
```
